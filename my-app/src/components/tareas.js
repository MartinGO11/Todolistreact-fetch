...
const Tareas = () => {
    ...
    let url = "https://assets.breatheco.de/apis/fake/todos/user/MartinGO11";
        ...
        <div className="container-fluid">
            ...
            <table className="App">
                <tbody>
                    ...
                    <tr>
                        <td className='text-end'><button type="button" className='btn btn-secondary btn-sm' onClick={removeAll}>Eliminar tareas</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
